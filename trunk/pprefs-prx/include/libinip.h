/*
 ...
 INI Library Portable ver. 1.02   by hiroi01
...
/*
 keynumberで指定した項目にデフォルト値をセットします
 ...
 デフォルト値をセットする対象の項目番号
 */
void ILPSetDefaultOne(ILP_Key *key, int keynumber);
...
/*
 ...
 ILP_Key 構造体のアドレスを渡して下さい
 */
void ILPSetDefaultAll(ILP_Key *key);
...
u32 ILPGetTypeByKeynumber(ILP_Key *key, int keynumber);
